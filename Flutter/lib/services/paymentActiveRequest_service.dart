...
class PaymentActiveRequestService {

  paymentDone(int tripId, int userId)async{


    String url = "https://carshareflutter.herokuapp.com/paymentActiveRequest?tripId="+tripId.toString()+"&userId="+userId.toString();
