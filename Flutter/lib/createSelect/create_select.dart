...
import 'package:carshare/google_map_screens/create_from_google_map.dart';
...
class CreateSelectChoice extends StatefulWidget {


  const CreateSelectChoice({Key key}) : super(key: key);

  @override
  _CreateSelectChoiceState createState() =>
      _CreateSelectChoiceState();
}
var jsonTrips;

class _CreateSelectChoiceState extends State<CreateSelectChoice> {
