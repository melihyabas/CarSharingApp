...
class JoinFromSabiha extends StatefulWidget {
  @override
  _JoinFromSabihaState createState() => _JoinFromSabihaState();
}

class _JoinFromSabihaState extends State<JoinFromSabiha> {
  Completer<GoogleMapController> _mapController = Completer();

  JoinATripModel joinATripModel;
  StreamSubscription locationSubscription;

  _JoinFromSabihaState(){
                          ...
                          itemBuilder: (context, index){
                            return ListTile(
                              ...
                              onTap: (){
                                ...
                                joinATripModel.setStartAddress('Sabiha Gökçen Uluslararası Havalimanı (SAW), Pendik/İstanbul');
  ...
  Future<void> _goToPlace(Place place) async {
    ...
    await joinATripModel.setStartLat('40.905371');
    await joinATripModel.setStartLong('29.3168603');
