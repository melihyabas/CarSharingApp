...
class JoinGoGoogleMap extends StatefulWidget {
  final JoinATripModel joinATripModel;

  const JoinGoGoogleMap({ @required this.joinATripModel});

  @override
  _JoinGoGoogleMapState createState() => _JoinGoGoogleMapState(joinATripModel);
}

class _JoinGoGoogleMapState extends State<JoinGoGoogleMap> {
  JoinATripModel joinATripModel;

  _JoinGoGoogleMapState(JoinATripModel joinATripModel)
  {
            ...
            children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: GoogleMap(
                        ...
                        onMapCreated:  (GoogleMapController controller) { //important change here
                          ...
                          itemBuilder: (context, index){
                            return ListTile(
                              ...
                              onTap: (){
                                ...
                                joinATripModel.setEndAddress(endAddress);
              ...
              Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      if(joinATripModel.endpointLat==null){
                        var locLat = applicationBloc.currentLocation.latitude;
                        var locLong = applicationBloc.currentLocation.longitude;
                        await joinATripModel.setEndLat(locLat.toString());
                        await joinATripModel.setEndLong(locLong.toString());
                      }
                      print('\n\n\n\n\n**********Lat: '+joinATripModel.endpointLat.toString()+' Long: '+joinATripModel.endpointLong.toString()+' Name: '+joinATripModel.endAddress);
                      try {
