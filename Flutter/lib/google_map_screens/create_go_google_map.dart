...
class CreateGoogleMap extends StatefulWidget {
  @override
  _CreateGoogleMapState createState() => _CreateGoogleMapState();
}

class _CreateGoogleMapState extends State<CreateGoogleMap> {
  Completer<GoogleMapController> _mapController = Completer();

  CreateATripModel createATripModel;
  StreamSubscription locationSubscription;

  _CreateGoogleMapState(){
                          ...
                          itemBuilder: (context, index){
                            return ListTile(
                              ...
                              onTap: (){
                                ...
                                createATripModel.setStartAddress(startAddress);
                                createATripModel.setEndAddress('Sabiha Gökçen Uluslararası Havalimanı (SAW), Pendik/İstanbul');
  ...
  Future<void> _goToPlace(Place place) async {
    ...
    await createATripModel.setStartLat(locLat.toString());
    await createATripModel.setStartLong(locLong.toString());
    await createATripModel.setEndLat('40.905371');
    await createATripModel.setEndLong('29.3168603');
