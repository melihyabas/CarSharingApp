...
import '../buy_points/buy_points_widget.dart';
import '../flutter_flow/flutter_flow_icon_button.dart';
import '../flutter_flow/flutter_flow_theme.dart';
import '../flutter_flow/flutter_flow_util.dart';
import '../login_page/login_page_widget.dart';
import '../saved_trip_page/saved_trip_page_widget.dart';
...
class ProfilePageWidget extends StatefulWidget {
  ...
  @override
  _ProfilePageWidgetState createState() => _ProfilePageWidgetState(user: user);
}
...
class _ProfilePageWidgetState extends State<ProfilePageWidget> {
  ...
  final UserModel user;
   ...
   _ProfilePageWidgetState({ @required this.user});
                        ...
                        Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                (user.firstname+' '+user.lastname)??'default val',
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => BuyPointsWidget(),
                                ),
                              );
                            },
                          ),
